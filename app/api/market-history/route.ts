  ...
  try {
    const [venue, recorded] = await Promise.all([
      fetchHistoryWithTokens(
        { ticker: kxTicker, eventTitle: url.searchParams.get('kxevent') ?? '', title: url.searchParams.get('kxtitle') ?? '', yesBid: null, yesAsk: null, volume: 0, updatedAt: null, rules: null, bidSize: null, askSize: null },
        { id: pmId, question: '', outcomes: null, outcomePrices: null, clobTokenIds: pmClob, volume24hr: 0, volume: 0, liquidity: 0, endDate: null, slug: null, description: null },
        pmClob,
        tier
      ),
