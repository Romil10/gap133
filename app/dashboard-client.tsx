                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="netcell">
                        {p.netGap !== null ? (
                          <>
                            <div className={`netmain ${p.netPositive ? 'pos' : 'neg'}`}>
                              {p.netGap >= 0 ? '+' : ''}{p.netGap.toFixed(1)}¢
                            </div>
                            {p.netPositive && <div className="netpos" title="Clears both venues' taker fees">net +</div>}
                          </>
                        ) : '—'}
                      </td>
